...
Looking at ``__plugin__.sample_plugin.db_sample``:
...
Configuring the service setup ``__plugin__.sample_plugin.db_sample``
...
Adding the API configuration ``__plugin__.sample_plugin.db_sample``:
...
Editing the implementation ``__plugin__.sample_plugin.db_sample``:
